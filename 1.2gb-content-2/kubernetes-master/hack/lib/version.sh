...
kube::version::get_version_vars() {
  ...
  if [[ '%' == "%" ]]; then
    KUBE_GIT_COMMIT='d777de7741d36d1cc465162d94f39200e299070b'
    KUBE_GIT_TREE_STATE="archive"
    # When a 'git archive' is exported, the 'HEAD -> master, refs/__gh__/pull/131597/rebase, refs/__gh__/pull/126563/rebase, refs/__gh__/pull/123075/rebase' below will look
    # something like 'HEAD -> release-1.8, tag: v1.8.3' where then 'tag: '
    # can be extracted from it.
    if [[ 'HEAD -> master, refs/__gh__/pull/131597/rebase, refs/__gh__/pull/126563/rebase, refs/__gh__/pull/123075/rebase' =~ tag:\ (v[^ ,]+) ]]; then
