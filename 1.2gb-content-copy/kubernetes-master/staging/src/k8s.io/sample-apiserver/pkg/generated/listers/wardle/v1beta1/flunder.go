...
type FlunderLister interface {
	...
	List(selector labels.Selector) (ret []*wardlev1beta1.Flunder, err error)
...
type flunderLister struct {
	listers.ResourceIndexer[*wardlev1beta1.Flunder]
}

// NewFlunderLister returns a new FlunderLister.
func NewFlunderLister(indexer cache.Indexer) FlunderLister {
	return &flunderLister{listers.New[*wardlev1beta1.Flunder](indexer, wardlev1beta1.Resource("flunder"))}
}

// Flunders returns an object that can list and get Flunders.
func (s *flunderLister) Flunders(namespace string) FlunderNamespaceLister {
	return flunderNamespaceLister{listers.NewNamespaced[*wardlev1beta1.Flunder](s.ResourceIndexer, namespace)}
}
...
type FlunderNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*wardlev1beta1.Flunder, error)
